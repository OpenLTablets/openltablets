...
public class EditProjectTagsBean {
    ...
    public void init(TreeNode selectedNode) {
        ...
        if (selectedProject != null) {
            ...
            ProjectTags projectTags = project.getTags();

            tags = projectTags.getLocalTags().entrySet().stream()
                    .map(entry -> {
        ...
        try {
            ...
            if (repoId != null && realPath != null) {
                ...
                if (rulesProjectOptional.isPresent()) {
                    ...
                    ProjectTags projectTags = rulesProjectOptional.map(RulesProject::getTags).get();
                    var currentTags = new HashMap<>(projectTags.getLocalTags());
                    ...
                    if (changed) {
                        ...
                        projectTags.saveLocalTags(currentTags);
