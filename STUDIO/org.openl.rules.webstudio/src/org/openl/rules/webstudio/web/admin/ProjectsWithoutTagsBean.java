...
public class ProjectsWithoutTagsBean {
    ...
    public void init() {
        ...
        for (RulesProject project : projects) {
            ...
            Map<String, String> currentTags = project.getTags().getLocalTags();
    ...
    public void applyTags() throws ProjectException {
        ...
        for (ProjectWithChangedTags projectWithChangedTags : projectsWithoutTags) {
            if (projectWithChangedTags.fillTags) {
                ...
                ProjectTags projectTags = projectWithChangedTags.getRulesProject().getTags();
                
                var tagsToSave = new HashMap<>(projectTags.getLocalTags());
                tagsToSave.putAll(newTagsMap);
                projectTags.saveLocalTags(tagsToSave);
    ...
    public static class ProjectWithChangedTags {
        ...
        public List<TagDTO> getTags() {
            ...
            Map<String, String> localTags = rulesProject.getTags().getLocalTags();
            for (Tag tag : tags) {
