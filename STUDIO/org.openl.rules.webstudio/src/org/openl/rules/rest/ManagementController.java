...
public class ManagementController {
    ...
    public void saveSettings(@RequestBody GroupSettingsModel request) throws IOException {
        ...
        DynamicPropertySource.get().save(Map.of(SECURITY_DEF_GROUP_PROP, request.getDefaultGroup()));
    }
    ...
    public GroupSettingsModel getSettings() {
        ...
        model.setDefaultGroup(environment.getProperty(SECURITY_DEF_GROUP_PROP));
        return model;
    }
